...
public class Day7Tests
{
	...
	public async Task Part1(string memory, int expected)
	{
		Assert.AreEqual(expected, await new Day7(memory).Part1());
	}
	...
	public async Task Part2(string memory, int expected)
	{
		Assert.AreEqual(expected, await new Day7(memory).Part2());
	}
}
