...
namespace AdventOfCode.Year2019
{
	...
	public class Day7Tests
	{
		...
		public void Part1(string memory, int expected)
		{
			Assert.AreEqual(expected, new Day7(memory).Part1());
		}
		...
		public void Part2(string memory, int expected)
		{
			Assert.AreEqual(expected, new Day7(memory).Part2());
		}
	}
}
